...
from .serializers import UserSerializer, RecastSerializer, RecastInstSerializer
# , ActorSerializer, MovieSerializer, CastInstSerializer
...
class RecastInstViewSet(viewsets.ModelViewSet):
    ...
    serializer_class = RecastInstSerializer
